                  ...
                  >
                    ...
                    >
                      ...
                      <View style={{ width: "70%", borderRightWidth: 1 }}>
                        ...
                        >
                          80 TTA Exemption of Savings Bank Interest ( Maximum
                          Rs. 10000/- )
                        </Text>
                      </View>
                  ...
                  >
                    ...
                    >
                      <View style={{ width: "73.7%", borderRightWidth: 1 }}>
                        ...
                        >
                          Less:- Deduction U/S 87A ( Maximum Rs. 12500 for
                  ...
                  >
                    ...
                    >
                      <View style={{ width: "73.7%", borderRightWidth: 1 }}>
                        ...
                        >
                          Add surcharge on col. No.24 ( for toxoble income over
                          Rs. 10000000/-)
                        </Text>
                      </View>
                  ...
                  >
                    ...
                    >
                      <View style={{ width: "73.7%", borderRightWidth: 1 }}>
                        ...
                        >
                          Balance Tax + Cess after relief U/S 89 ( 1 ) [ 28 -
                          29]
                        </Text>
                      </View>
            ...
            <View style={styles.pageMainView}>
              <View style={styles.mainBorderView}>
                ...
                <View style={styles.rowStartBorderView}>
                  <View style={[styles.view16, { height: 50 }]}>
                    <Text style={styles.text}>MONTH</Text>
                  </View>
                  <View
                    style={{ width: "109%", borderRightWidth: 1, height: 50 }}
                  >
                    <View style={{ width: "100%", borderBottomWidth: 1 }}>
                    ...
                    >
                      <View style={[styles.view10, { height: 40 }]}>
                        <Text style={styles.text}>% D.A</Text>
                      </View>
                      <View style={[styles.view16, { height: 40 }]}>
                  ...
                  <View style={[styles.view16, { width: "32%", height: 50 }]}>
