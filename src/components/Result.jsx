...
const Result = () => {
  ...
  const { state, setStateArray, resultState, setResultState } =
    useGlobalContext();
            ...
            {studentsList.length > 0 && (
              <div className="mt-3">
                <button
                  ...
                  onClick={() => {
                    navigate(`/StudentsPhotoCorner`);
                    setStateArray(studentsList);
                  }}
                >
                  Photo Corner
                </button>
                <button
                  ...
                  onClick={() => {
                    createDownloadLink(studentsList, tableName);
                  }}
                >
                  Download Data
                </button>
            ...
            <div className="allresult-section mb-3">
              ...
              {showAllClassResult ? (
                <div className="mb-3">
                  <div>
                    {/* <Link
                      to={`/AllPPResult?details=${JSON.stringify(
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        navigate("/AllPPResult");
                      }}
                    >
                      Class PP
                    </button>
                    <Link
                      to={`/AllClass12Result?details=${JSON.stringify(
                    ...
                    <Link
                      to={`/AllClass345Result?details=${JSON.stringify(
              ...
              {showERegister ? (
                <div>
                  <Link
                    to={`/ClassPPERegister?details=${JSON.stringify(
                      studentsList.filter((el) => el.nclass === 0)
                    )}`}
                    className="btn btn-info m-2 btn-sm"
                  >
                  ...
                  <Link
                    to={`/Class12ERegister?details=${JSON.stringify(
                      studentsList.filter(
                        (el) => el.nclass === 1 || el.nclass === 2
                      )
                    )}`}
                    className="btn btn-warning m-2 btn-sm"
                  >
                  ...
                  <Link
                    to={`/Class345ERegister?details=${JSON.stringify(
                      studentsList.filter((el) => el.nclass === 3)
                    )}`}
                    className="btn btn-success m-2 btn-sm"
                  >
