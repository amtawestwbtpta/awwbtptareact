            ...
            <View style={styles.pageMainView}>
              <View style={styles.mainBorderView}>
                ...
                >
                  ...
                  >
                    <Text style={styles.textBold}>
                      Rs. {IndianFormat(50000 + grossPTax)}
                    </Text>
                  </View>
                  <View
                    style={{
                ...
                >
                  ...
                  >
                    <Text style={styles.textBold}>
                      Rs.{" "}
                      {IndianFormat(
                        AllGross - 50000 + grossPTax + BankInterest
                      )}
                    </Text>
                  </View>
                  <View
              ...
              <View style={styles.mainBorderView}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Text style={styles.textBold}>14) ROUNDED OFF</Text>
                    </View>
                    <View
                      style={{
                        width: "20%",
                  ...
                  >
                    ...
                    >
                      <Text style={styles.textBold}>17) TAX ON SURCHARGE</Text>
                    </View>
                    <View
                      style={{
                        width: "20%",
                ...
                >
                  ...
                  <Text style={styles.text}> son/daughter of </Text>
                  <Text
                    style={[
                      styles.text,
                      {
