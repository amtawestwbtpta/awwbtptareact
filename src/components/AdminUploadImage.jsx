                  ...
                  .then(async (data) => {
                    ...
                    try {
                      ...
                      if (folder === "slides") {
                        ...
                        const nextApi = `https://awwbtpta.vercel.app/api/addSlides`;
              ...
              getDownloadURL(uploadTask.snapshot.ref).then(async (url) => {
                ...
                if (editField.cloudinaryUrl) {
                  try {
                    ...
                    const cloudinaryUpDel = `https://awwbtpta.vercel.app/api/cloudinaryUpDel`;
                ...
                await axios.post(cldUrl, data).then(async (data) => {
                  ...
                  try {
                    ...
                    if (folder === "slides") {
                      ...
                      setSlideState(y);
                      setSlideUpdateTime(Date.now());
                      const nextApi = `https://awwbtpta.vercel.app/api/updateSlide`;
                      const response = await axios.post(nextApi, {
                        title: editField.title,
                        description: editField.description,
                        url: url,
