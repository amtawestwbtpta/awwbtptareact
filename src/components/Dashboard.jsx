...
import { GetMonthName, INR, IndianFormat } from "../modules/calculatefunctions";
      ...
      {showLoader ? (
        ...
        <div>
          ...
          <div className="container text-center d-flex flex-column justify-content-center">
            ...
            <div>
              <Link className="btn btn-primary m-2 rounded" to="/update_self">
                Update Profile
              </Link>
              <Link className="btn btn-success m-2 rounded" to="/AiChatBot">
                Chat With AI
              </Link>
            </div>
          </div>
