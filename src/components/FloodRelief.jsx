...
export default function FloodRelief() {
  ...
  const getData = async () => {
    try {
      ...
      // const url = `https://awwbtpta.vercel.app/api/getRelief`;
  ...
  const submitData = async () => {
    ...
    try {
      ...
      // const url = `https://awwbtpta.vercel.app/api/addRelief`;
  ...
  const updateComp = (data) => {
    const newData = sortByDateAndName(data);
    setAllData(newData);
  ...
  const updateData = async () => {
    ...
    try {
      ...
      // const url = `https://awwbtpta.vercel.app/api/updateRelief`;
  ...
  const deleteData = async (id) => {
    ...
    try {
      ...
      // const url = `https://awwbtpta.vercel.app/api/delRelief`;
  ...
  function sortByDateAndName(array) {
    return array.sort((a, b) => {
      ...
      // If dates are equal, then compare by name
