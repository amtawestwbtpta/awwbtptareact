...
import { INR, GetMonthName, printDate } from "../modules/calculatefunctions";
import { HRA } from "../modules/constants";
import { PDFDownloadLink } from "@react-pdf/renderer";
import OSMSPaySLip from "./Helpers/OSMSPaySLip";
                    ...
                    <>
                      ...
                      >
                        ...
                        >
                          ...
                          <tr>
                            <td style={{ textAlign: "right" }}>{salary.da}</td>
                          </tr>
                          <tr>
                            <td style={{ textAlign: "right" }}>{salary.hra}</td>
                          </tr>
                          <tr>
                            <td style={{ textAlign: "right" }}>{salary.ma}</td>
                          </tr>
                          <tr>
