...
import { NumInWords, round2dec, round5 } from "../modules/calculatefunctions";

const PrintQuestionInvoice = () => {
  const navigate = useNavigate();
  const { stateObject, questionRateState } = useGlobalContext();
  const allData = stateObject;
  const qRate = questionRateState;
  let sl = allData.sl;
