...
const Form16 = () => {
  ...
  return (
    ...
    >
      <h5 className="my-0 text-center" style={{ marginTop: "20px !important" }}>
          ...
          <table style={{ width: "100%", border: "2px solid" }}>
            ...
            <tr>
              <th
                ...
                rowSpan="4"
              >
                TDS Circle where Annual Reaturn /<br /> Statement Under Section
                206 is to be filled
              </th>
              <th
                className="text-center font-weight-bold"
            ...
            <tr>
              <th className="text-center" style={{ borderRight: "2px solid" }}>
                {" "}
              </th>
              <th className="text-center" style={{ borderRight: "2px solid" }}>
                {" "}
            ...
            <tr>
              <th
                className="text-center"
                style={{ borderRight: "2px solid", borderBottom: "2px solid" }}
              >
                {year}
              </th>
              <th
              ...
              <th className="text-center" style={{ borderBottom: "2px solid" }}>
                {year + " - " + (year + 1)}
              </th>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <th
                ...
                className="p-1 text-center"
              ></th>
              <th className="p-1 text-center">{tgross - totalptax - 50000}</th>
            </tr>
            <tr>
              <th
                colSpan="2"
            ...
            <tr>
              ...
              <th className="p-1 pb-2 text-center pt-4">{"Rs." + gpf * 12}</th>
            </tr>
            <tr>
              <th
                colSpan="2"
            ...
            <tr>
              <th
                ...
                className="pl-4 pt-4 pb-2"
              >
                {"13)"}&nbsp;&nbsp;&nbsp;TOTAL OR NET TAXABLE INCOME {"(10-12)"}
              </th>
              <th
                style={{ borderRight: "2px solid" }}
                className="p-1 pb-2 text-center pt-4"
