...
import { GetMonthName, INR, printDate } from "../modules/calculatefunctions";
import { PDFDownloadLink } from "@react-pdf/renderer";
import WBTPTAPaySLip from "./Helpers/WBTPTAPaySLip";
    ...
    >
      {loader ? (
        ...
        <div>
          ...
          onClick={() => {
            navigate(
              `/DownloadWBTPTAPayslip?data=${JSON.stringify(stateObject)}`
            );
          }}
        >
          Go To Download
          ...
          <div className="row">
            ...
            >
              ...
              <tr>
                ...
                <td
                  rowSpan={dataYear === 2024 && index === 7 ? 3 : 2}
                  colSpan={2}
                  style={{
                    border: "1px solid",
                    textAlign: "center",
