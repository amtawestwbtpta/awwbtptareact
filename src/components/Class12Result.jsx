...
const Class12Result = () => {
  ...
  let comm_summ_totalmarks =
    parseInt(studentdata.summative_1_comm) +
    parseInt(studentdata.summative_2_comm) +
    parseInt(studentdata.summative_3_comm);
  let comm_summ_totalmarks_per = parseInt(
    round2dec((comm_summ_totalmarks * 50) / 100)
  );
  let comm_summ_totalmarks_percent = percentTotal(comm_summ_totalmarks_per);
  let corr_summ_totalmarks =
    parseInt(studentdata.summative_1_corr) +
    parseInt(studentdata.summative_2_corr) +
    parseInt(studentdata.summative_3_corr);
  let corr_summ_totalmarks_per = parseInt(
    round2dec((corr_summ_totalmarks * 50) / 100)
  );
  let corr_summ_totalmarks_percent = percentTotal(corr_summ_totalmarks_per);
  let prob_summ_totalmarks =
    parseInt(studentdata.summative_1_Prob) +
    parseInt(studentdata.summative_2_Prob) +
    parseInt(studentdata.summative_3_Prob);
  let prob_summ_totalmarks_per = parseInt(
    round2dec((prob_summ_totalmarks * 50) / 100)
  );
  let prob_summ_totalmarks_percent = percentTotal(prob_summ_totalmarks_per);
  let mp_summ_totalmarks =
    parseInt(studentdata.summative_1_ment_phy) +
    parseInt(studentdata.summative_2_ment_phy) +
    parseInt(studentdata.summative_3_ment_phy);
                    ...
                    <td width="100%" style={{ padding: "0px !important" }}>
                      <table width="100%" className="borderBlue">
                        ...
                        <tr style={{}}>
                          ...
                          >
                            {studentdata.summative_1_comm !== 0
                              ? studentdata.summative_1_comm
                              : ``}
                          </td>
                          <td
                            style={{
                          ...
                          >
                            {studentdata.summative_2_comm !== 0
                              ? studentdata.summative_2_comm
                              : ``}
                          </td>
                          <td
                            style={{
                          ...
                          >
                            {studentdata.summative_3_comm !== 0
                              ? studentdata.summative_3_comm
                              : ``}
                          </td>
                          <td
                            className="total"
                        ...
                        <tr>
                          ...
                          >
                            {studentdata.summative_1_corr !== 0
                              ? studentdata.summative_1_corr
                              : ``}
                          </td>
                          <td
                            style={{
                          ...
                          >
                            {studentdata.summative_2_corr !== 0
                              ? studentdata.summative_2_corr
                              : ``}
                          </td>
                          <td
                            style={{
                          ...
                          >
                            {studentdata.summative_3_corr !== 0
                              ? studentdata.summative_3_corr
                              : ``}
                          </td>
                          <td
                            className="total"
                        ...
                        <tr style={{}}>
                          ...
                          >
                            {studentdata.summative_1_Prob !== 0
                              ? studentdata.summative_1_Prob
                              : ``}
                          </td>
                          <td
                            style={{
                          ...
                          >
                            {studentdata.summative_2_Prob !== 0
                              ? studentdata.summative_2_Prob
                              : ``}
                          </td>
                          <td
                            style={{
                          ...
                          >
                            {studentdata.summative_3_Prob !== 0
                              ? studentdata.summative_3_Prob
                              : ``}
                          </td>
                          <td
                            className="total"
                        ...
                        <tr style={{}}>
                          ...
                          >
                            {studentdata.summative_1_ment_phy !== 0
                              ? studentdata.summative_1_ment_phy
                              : ``}
                          </td>
                          <td
                            style={{
                          ...
                          >
                            {studentdata.summative_2_ment_phy !== 0
                              ? studentdata.summative_2_ment_phy
                              : ``}
                          </td>
                          <td
                            style={{
                          ...
                          >
                            {studentdata.summative_3_ment_phy !== 0
                              ? studentdata.summative_3_ment_phy
                              : ``}
                          </td>
                          <td
                            className="total"
